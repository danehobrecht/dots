...
echo -e 'tldr\t\tsummarize a command\napropos\t\tsearch the manual pages for names and descriptions\nlocate\t\tfind a file quickly\nbc\t\tcommand-line calculator\ntime\t\tcalculate execution time\ntree\t\tquickly visualize file tree\nxxd\t\tview machine code of file\nbase64\t\tencode/decode\ninfo\t\tmore verbose manuals\ndiff\t\tline-by-line differences between files' # Startup informational message
